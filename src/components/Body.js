...
if(listofRestaurant.length===0){
  ...
  <div className="body">
    <div className="search m-4 p-4">
      <input className="border-black border-2 border-solid" type="text" value={searchText} onChange={(events)=>{
        setSearchText(events.target.value)
      }}/>
      
      <button className="bg-green-100 px-8 m-4 border-black border-solid border-2" onClick={()=>{
      ...
      <input className="border border-black p-2" value={logInUser} onChange={(e)=>setUserName(e.target.value)}/>
    </div>
